                                ...
                                <form action="" method="post" id="form">
                                    ...
                                    <div class='btn-navigation'>
                                        <div class='pull-right'>
                                            <a class="btn btn-primary" href="<?php echo site_url();?>website/barang"><i class="fa fa-refresh"></i></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
	                        ...
	                        if ($jml_data > 0){
	                            ...
	                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <b>Dibuat:</b> <?php echo dateIndo($row->barang_created);?><br>
                                                <b>Terakhir diubah:</b> <?php echo dateIndo($row->barang_updated);?>
                                </td>
                            <?php if ($admin->admin_level_kode == 1) { ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="javascript:;" class="btn btn-danger" id="hapus-barang">Ya</a>
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/barang/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                            <div class="form-group form-material">
                                ...
                                <input type="text" class="form-control input-sm" id="nama_barang" name="nama_barang" placeholder="Nama barang" required/>
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Merk</label>
                                <input type="text" class="form-control input-sm" id="merek" name="merek" placeholder="Merk" required/>
                            </div>
                            <div class='button center'>
                                <input class="btn btn-primary btn-sm" type="submit" name="simpan" value="Simpan Data" id="validateButton2">
                                <input class="btn btn-default btn-sm" type="reset" name="batal" value="Batalkan" onclick="location.href='<?php echo site_url(); ?>website/barang'"
                                />
                            </div>
                        </form>
                    </div>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/barang/edit/<?php echo $id_barang;?>" method="post" id="exampleStandardForm" autocomplete="off">
                            ...
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Nama barang</label>
                                <input type="text" value="<?php echo $nama_barang; ?>" class="form-control input-sm" id="nama_barang" name="nama_barang" placeholder="Nama barang"
                                    required/>
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Merk</label>

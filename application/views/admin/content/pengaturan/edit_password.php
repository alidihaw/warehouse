                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>pengaturan/edit_password/<?php echo $admin_user;?>" method="post" enctype="multipart/form-data" id="exampleStandardForm"
                            ...
                            <div class="form-group form-material">
                                ...
                                <input type="password" class="form-control input-sm" id="admin_pass_recent" name="admin_pass_recent" placeholder="Masukan Password Sekarang" required />
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Password Baru</label>
                                <input type="password" class="form-control input-sm" id="admin_pass" name="admin_pass" placeholder="Masukan Password Baru" required />
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Ulangi Password</label>
                                <input type="password" class="form-control input-sm" id="admin_pass_ulang" name="admin_pass_ulang" placeholder="Ulangi Password" required />
                            </div>
